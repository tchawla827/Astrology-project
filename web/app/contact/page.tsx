...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact Naksha support.",
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20 pt-32">
        <div className="cinematic-hero p-6 sm:p-8">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-6 text-muted-foreground">
            For account, privacy, or product support, email the Naksha team.
          </p>
          <Link className="mt-8 inline-flex min-h-11 items-center gap-2 rounded-md border border-primary/30 bg-background/45 px-4 py-3 text-sm transition-colors hover:border-primary/60 hover:bg-primary/10" href="mailto:support@naksha.app">
