    ...
    <main className="cinematic-scene relative grid min-h-screen place-items-center overflow-hidden px-6 py-10">
      ...
      <div className="relative grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_28rem] lg:items-center">
        <section className="hidden max-w-2xl lg:block">
          <BrandLogo markClassName="h-11 w-11" textClassName="text-4xl" />
          ...
          <p className="mt-5 text-sm leading-6 text-muted-foreground">
            Create the account first, then add birth details once so Naksha can build your structured Vedic snapshot.
          </p>
        </section>
        ...
        <Card className="luxury-panel">
          <CardHeader className="space-y-4">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-primary">Naksha</p>
